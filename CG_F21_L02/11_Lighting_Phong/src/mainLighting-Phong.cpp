...
// Global Variables
const char* APP_TITLE = " Computer Graphics - Lighting Phong Shading Model";
...
int main()
{
	...
	texture[4].loadTexture("res/models/redball.png", true); 
